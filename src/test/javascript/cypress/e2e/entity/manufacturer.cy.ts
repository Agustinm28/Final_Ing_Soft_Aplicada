...
describe('Manufacturer e2e test', () => {
  ...
  const manufacturerSample = { name: 'Frozen' };
  ...
  describe('Manufacturer page', () => {
    ...
    describe('with existing value', () => {
      ...
      it.skip('edit button click should load edit Manufacturer page and save', () => {
        cy.get(entityEditButtonSelector).first().click();
        cy.getEntityCreateUpdateHeading('Manufacturer');
  ...
  describe('new Manufacturer page', () => {
    ...
    it('should create an instance of Manufacturer', () => {
      cy.get(`[data-cy="name"]`).type('Internal overriding Licensed').should('have.value', 'Internal overriding Licensed');
