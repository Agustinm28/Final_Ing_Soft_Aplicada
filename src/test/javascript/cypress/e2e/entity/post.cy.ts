...
describe('Post e2e test', () => {
  ...
  const postSample = {
    title: 'Asociado programming transmitter',
    content: 'Li4vZmFrZS1kYXRhL2Jsb2IvaGlwc3Rlci50eHQ=',
    date: '2023-10-26T11:55:30.287Z',
  };
  ...
  describe('new Post page', () => {
    ...
    it('should create an instance of Post', () => {
      cy.get(`[data-cy="title"]`).type('Gris').should('have.value', 'Gris');
      ...
      cy.get(`[data-cy="date"]`).type('2023-10-26T09:47').blur().should('have.value', '2023-10-26T09:47');
